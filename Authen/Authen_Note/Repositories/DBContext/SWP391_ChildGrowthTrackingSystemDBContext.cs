...
public partial class SWP391_ChildGrowthTrackingSystemDBContext : DbContext
{
    public SWP391_ChildGrowthTrackingSystemDBContext()
    {
    }

    public SWP391_ChildGrowthTrackingSystemDBContext(DbContextOptions<SWP391_ChildGrowthTrackingSystemDBContext> options)
        : base(options)
    {
    }
    ...
    //        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-AGJF065R\\NGUYEN;Initial Catalog=SWP391_ChildGrowthTrackingSystemDB;Persist Security Info=True;User ID=sa;Password=12345;Encrypt=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alert>(entity =>
        {
            entity.HasKey(e => e.AlertId).HasName("PK__Alerts__EBB16AED5557C9F8");
        ...
        {
            entity.HasKey(e => e.BlogId).HasName("PK__Blogs__54379E5072AD119E");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__BlogCate__19093A2BFB7AC15B");
        ...
        {
            entity.HasKey(e => e.ChildId).HasName("PK__Children__BEFA0736CBE4F750");
        ...
        {
            entity.HasKey(e => new { e.ChildId, e.MilestoneId }).HasName("PK__ChildMil__2E664F33E1E44674");
        ...
        {
            entity.HasKey(e => e.RequestId).HasName("PK__Consulta__33A8519AAD46B724");
            ...
            entity.HasOne(d => d.Doctor).WithMany(p => p.ConsultationRequests)
        ...
        {
            entity.HasKey(e => e.ResponseId).HasName("PK__Consulta__1AAA640C3E4F0CF8");

            entity.HasIndex(e => e.RequestId, "UQ__Consulta__33A8519B0E87F3EE").IsUnique();
            ...
            entity.HasOne(d => d.Request).WithOne(p => p.ConsultationResponse)
        ...
        {
            entity.HasKey(e => e.DiseaseId).HasName("PK__Diseases__69B533A9F5D7AA04");
        ...
        {
            entity.HasKey(e => e.DoctorId).HasName("PK__Doctors__2DC00EDFF173AF93");

            entity.HasIndex(e => e.PhoneNumber, "UQ__Doctors__85FB4E38E9005A12").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Doctors__A9D1053463D589F7").IsUnique();
        ...
        {
            entity.HasKey(e => e.DoctorSpecializationId).HasName("PK__DoctorSp__14F6ED6D9C042089");
        ...
        {
            entity.HasKey(e => e.FeatureId).HasName("PK__Features__82230A2917D0021C");
        ...
        {
            entity.HasKey(e => e.RecordId).HasName("PK__GrowthRe__FBDF78C9DFBBBF92");
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__Members__0CF04B386B9DD87F");

            entity.HasIndex(e => e.UserId, "UQ__Members__1788CCADCCB6AACB").IsUnique();
        ...
        {
            entity.HasKey(e => e.MemberMembershipId).HasName("PK__MemberMe__5EAB967FA3628DCE");
        ...
        {
            entity.HasKey(e => e.PackageId).HasName("PK__Membersh__322035EC5BC0D07A");
        ...
        {
            entity.HasKey(e => e.MilestoneId).HasName("PK__Mileston__09C48058B1E725F1");
        ...
        {
            entity.HasKey(e => new { e.PackageId, e.FeatureId }).HasName("PK__PackageF__BA02054E593070FE");
        ...
        {
            entity.HasKey(e => new { e.PackageId, e.PromotionId }).HasName("PK__PackageP__D70C771E5AE3334F");
        ...
        {
            entity.HasKey(e => e.PromotionId).HasName("PK__Promotio__52C42F2F3948C19A");
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__RatingFe__6A4BEDD63D87F8EB");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE3AD7C2B75F");
        ...
        {
            entity.HasKey(e => e.SpecializationId).HasName("PK__Speciali__5809D84FAEFD2C37");
        ...
        {
            entity.HasKey(e => e.TransactionId).HasName("PK__Transact__55433A4B9476EC7D");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__UserAcco__1788CCAC7416798C");

            entity.HasIndex(e => e.Username, "UQ__UserAcco__536C85E43C1F4AF1").IsUnique();

            entity.HasIndex(e => e.PhoneNumber, "UQ__UserAcco__85FB4E384C3B0C1A").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__UserAcco__A9D10534371D79B4").IsUnique();
